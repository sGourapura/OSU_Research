...
const int DNA_GARBAGE_END = 8; // This global constant defines where in generationDNA.csv data begins. Data should begin on the NEXT line after this; so if 8, the first line of data is on line 9.
...
const float INITIAL_MEAN_C1_G2 = 15.0f; // When we initially run, this is the average value seeded for the gene.

const float INITIAL_STD_DVN_C1_G2 = 10.0f; // When starting a new generation, this is the starting variance for the gene.

// Gene Three, Gene One controls angle (in radians) currently

const float INITIAL_MEAN_C1_G3 = M_PI / 8; // When we initially run, this is the average value seeded for the gene.

const float INITIAL_STD_DVN_C1_G3 = M_PI / 8; // When starting a new generation, this is the starting variance for the gene.
...
const float MUT_MODULATOR = 1.333; // This is inversely proportional to the magnitude of mutations. At 2, all mutations are halved in magnitude. The higher this goes, the slower evolution becomes.
