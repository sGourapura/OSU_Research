...
# This file contains every antenna's DNA and fitness score for each generation. Format for each individual is radius, length, angle, fitness score.

# First, stick genDNA with fScores to have the correct matrix fromat described above
...
with open("runData.csv", 'a') as runDataBinary:
	np.savetxt(runDataBinary, genDNAfScore, delimiter=",", fmt='%f')
